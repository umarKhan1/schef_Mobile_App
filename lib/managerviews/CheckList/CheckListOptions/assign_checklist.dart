...
class AssignCheckList extends StatefulWidget {
  const AssignCheckList({Key? key}) : super(key: key);

  @override
  _AssignCheckListState createState() => _AssignCheckListState();
}

class _AssignCheckListState extends State<AssignCheckList> {
  String dropdownValue = 'Select Machine';
  String dropdownValue1 = 'Select Interval';
                          ...
                          children:  [
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                underline:Container(),
                                items: <String>['Select Interval', 'Monthly', 'Weekly', 'Daily', 'Custom'] .map<DropdownMenuItem<String>>((
                                    String value){
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value, style: TextStyle(color: Colors.black), textScaleFactor: 1,),
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                underline:Container(),
                                items: <String>['Select User', '1', '2', '3', '4'] .map<DropdownMenuItem<String>>((
                                    String value){
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value, style: TextStyle(color: Colors.black), textScaleFactor: 1,),
