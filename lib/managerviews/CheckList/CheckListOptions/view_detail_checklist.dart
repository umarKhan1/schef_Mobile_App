...
class ViewDetailCheckList extends StatefulWidget {
  const ViewDetailCheckList({Key? key}) : super(key: key);

  @override
  _ViewDetailCheckListState createState() => _ViewDetailCheckListState();
}

class _ViewDetailCheckListState extends State<ViewDetailCheckList> {
